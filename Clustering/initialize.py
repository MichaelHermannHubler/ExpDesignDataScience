...
def get_20_newsgroups_dataset():    
   ...
   # news_train_tok = [tokenize_text(text) for text in newsgroup_train['text']]   # Tokenized data
   # newsgroup_train['tokens'] = news_train_tok

#    news_test_tok = [tokenize_text(text) for text in newsgroup_test['text']]   # Tokenized data
 #   newsgroup_test['tokens'] = news_test_tok
